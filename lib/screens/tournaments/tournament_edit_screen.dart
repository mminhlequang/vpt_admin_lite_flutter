...
class _TournamentEditScreenState extends State<TournamentEditScreen> {
  ...
  void _initializeControllers() {
    ...
    _surface = tournament.surface;
    if (!["hard", "clay", "grass", "carpet"].contains(_surface)) {
      _surface = null;
    }
    ...
    _packageId =
        tournament.packages?.isNotEmpty ?? false
            ? tournament.packages?.first.id ?? 1
            : 1;
          ...
          children: [
            ...
            Expanded(
              child: TextFormField(
                ...
                controller: TextEditingController(text: _endDate.formatDate()),
